...
def Cr_Amt(accnt,name):
	...
	l_title=tk.Message(creditwn,text="BANK OF DILI",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	...
	l_title=tk.Message(debitwn,text="BANK OF DILI",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def disp_bal(accnt):
	...
	bal=fdet.readline()
	fdet.close()
	messagebox.showinfo("Balance", f"{bal}.NGN")
...
def disp_tr_hist(accnt):
	...
	l_title=tk.Message(disp_wn,text="BANK OF DILI",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	rootwn.title("BANK OF DILI-"+name)
	rootwn.configure(background='orange')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="BANK OF DILI",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def log_in(master):
	master.destroy()
	loginwn=tk.Tk()
	loginwn.geometry("1200x300")
	loginwn.title("Log in")
	loginwn.configure(bg="red")
	fr1=tk.Frame(loginwn,bg="blue")
	l_title=tk.Message(loginwn,text="Welcome to BANK OF DILI",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="orange",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Create():
	...
	l_title=tk.Message(crwn,text="BANK OF DILI",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	Menu.title("BANK OF DILI")
	Menu.configure(background='blue')
	fr1=tk.Frame(Menu)
	fr1.pack(side="top")
	bg_image = tk.PhotoImage(file ="money1.gif")
	bg_image1 = bg_image.subsample(10,10)
	x = tk.Label (image = bg_image)
	x.place(y=00)
	l_title=tk.Message(text="BANK OF DILI",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	...
	b1.image=imgc
	b2=tk.Button(image=imglog,command=lambda: log_in(Menu))
	b2.image=imglog
	img6=tk.PhotoImage(file="quit.gif")
	myimg6=img6.subsample(2,2)

	b6=tk.Button(image=myimg6,command=Menu.destroy)
	b6.image=myimg6
	b1.place(x=200,y=200)
	b2.place(x=200,y=140)	
	b6.place(x=310,y=300)
